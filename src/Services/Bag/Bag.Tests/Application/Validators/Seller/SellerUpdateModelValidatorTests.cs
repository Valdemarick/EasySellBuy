...
public class SellerUpdateModelValidatorTests
{
    private readonly SellerUpdateModelValidator _validator;

    public SellerUpdateModelValidatorTests()
    {
        _validator = new();
    }

    private SellerUpdateModel BuildValidModel()
    {
        return new Fixture()
            .Build<SellerUpdateModel>()
